...
/*public class JwtAuthConverter implements Converter<Jwt, Collection<GrantedAuthority>>{
    public Collection<GrantedAuthority> convert(Jwt source){
        ...
        Map<String, Object> realmAccesRoles = source.getClaim("realm_acces");
        if(realmAccesRoles != null && !realmAccesRoles.isEmpty()){
            authorities.addAll(extractRoles(realmAccesRoles));
        }
        return authorities;
    }
